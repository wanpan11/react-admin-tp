...
React typescript backend management system project template, built-in dynamic nested routing, data mock, tailwindcss 🌙 Dark mode, dynamic breadcrumbs, custom form components。<br/>
